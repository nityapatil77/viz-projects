...
* Sample Size: If you run the script for not that long, the Correlation Heatmap and Price Tracker might show extreme relationships that wouldn't hold true over a full day.
